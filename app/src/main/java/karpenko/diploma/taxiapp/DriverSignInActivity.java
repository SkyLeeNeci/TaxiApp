                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(DriverSignInActivity.this, "Success", Toast.LENGTH_SHORT).show();
                            emailInputLayout.getEditText().getText().clear();
                            nameInputLayout.getEditText().getText().clear();
                            passwordInputLayout.getEditText().getText().clear();
                            passwordConfirmInputLayout.getEditText().getText().clear();
